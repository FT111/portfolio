    ...
    return (
      <Page>
          ...
          <Section className={"flex-col z-10"}>
              ...
              <div className={"px-8"}>
                  <div className={"bg-slate-200 h-[28rem] py-3 flex flex-row justify-center w-full rounded-2xl " +
                      "shadow-md"}>
                      <AutoCarousel>
                          <div className={"w-full h-full flex flex-col justify-between bg-sky-800 text-slate-50 rounded-2xl p-8"}>
                          ...
                          <div
                              ...
                              <div style={{gridRow:1, gridColumn:1}} className={"flex flex-col justify-between p-14 z-10"}>
                                  ...
                                  <div className={"flex flex-row justify-between items-end"}>
                                      ...
                                      <Link href={'https://github.com/FT111'}>
                                          <Button size={'lg'} variant={'outline'} className={"bg-slate-700/10 backdrop-blur"}>Check it out</Button>
                                      </Link>
                                  </div>
