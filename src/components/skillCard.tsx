...
export default function SkillCard({ skillTitle, skillColour, skillDescription, icon }: SkillCardProps) {
	...
	return (
		<>
			...
			<ScrollCard threshold={0.5} onClick={() => setIsOpen(!isOpen)}
						className={clsx(
				...
				<div className={"absolute flex w-full h-full p-4 justify-end align-bottom justify-items-end items-end"}>
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
						...
						<path stroke-linecap="round" className={"mix-blend-screen bg-blend-color-burn"} stroke-linejoin="round"
